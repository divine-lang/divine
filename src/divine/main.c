...
int main(int argc, char **argv) {
  ...
  mpc_err_t *err = mpca_lang(
      ...
      "           | <lexp> \"==\" <lexp> ;                               \n"
      "                                                                  \n"
      " typeident : (\"I0\" | \"I8\" | \"STR\" | \"I16\" | \"I32\" | \"I64\" | "
      "\"U64\" | \"U16\" | \"U8\" | \"U32\") <ident> ;                       \n"
      " decls     : (<typeident> ';')* ;                                 \n"
      " args      : <typeident>? (',' <typeident>)* ;                    \n"
      " exe      : \"exe\" <body>;                    \n"
      " body      : '{' <decls>* <stmt>* '}' ;                            \n"
      " procedure : (\"I0\" | \"I8\" | \"STR\" | \"I16\" | \"I32\" | \"I64\" | "
      "\"U64\" | \"U16\" | \"U8\" | \"U32\") <ident> '(' <args> ')' <body> ; \n"
      " includes  : ((\"please\")? \"use\" <string>)* ;                        "
      "   \n"
      " divine    : /^/ <includes>? <decls>* <procedure>* /$/ ;     \n",
      Ident, Number, Character, String, Factor, Term, Lexp, Stmt, Exp,
      Typeident, Decls, Args, Body, Procedure, exe, Includes, divine, NULL);
  ...
  mpc_cleanup(17, Ident, exe, Number, Character, String, Factor, Term, Lexp,
              Stmt, Exp, Typeident, Decls, Args, Body, Procedure, Includes,
              divine);
